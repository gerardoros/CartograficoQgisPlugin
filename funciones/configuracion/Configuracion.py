...
class Configuracion():
    ...
    def __init__(self):
        ...
        self.servidorIP = 'http://192.168.15.69:8784/'#192.168.0.69:8784
       ...
       #Urls para llenar table items
        ...
        self.urlCedCategoriasByIdUsoConstAndIdClase = self.servidorIP + 'featureswkn/api/cat-vuc/getCategoriasByIdConstrucciontAndIdClase/'
        self.urlGetCodigoByUsoClaseCatgoria = self.servidorIP + 'featureswkn/api/cat-vuc/getCodigoByUsoClaseCatgoria/'
        self.urlInfoValorCata = self.servidorIP + 'busquedasimplewkn/api/cedula/get-info-valor/'
        self.urlCalculoValorCata = self.servidorIP + 'busquedasimplewkn/api/valuacion/'
