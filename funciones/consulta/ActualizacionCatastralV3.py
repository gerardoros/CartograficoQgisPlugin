...
###############################################################################################
    ...
    def obtenerAPintar(self, idCapa):
        ...
        if self.traducirIdCapa(idCapa) == 'manzana':
            ...
            #print(self.traducirIdCapa(idCapa))
    ...
    def cargarTablita(self, si = ''):
        ...
        if self.abrePredio:
            ...
            # saber cual capa esta activa, a cual se le dio click
                ...
                #self.UTI.mostrarAlerta('No se aseleccionado un predio', QMessageBox().Warning, 'Cedula Catastral')
            if capaActiva.id() == self.obtenerIdCapa('predios.geom'):
            ...
            if len(features) != 1:
                ...
                self.dockwidget.lista[cve_recortada] = CedulaMainWindow(str(feat['cve_cat']), cond = cond, CFG = self.CFG, UTI = self.UTI, cargandoRevision = False, cve_len = self.cve_cat_len, si = str(si))
...
#-------------------------------------------------------------------
    ...
    def event_planoPred(self):
        PMA = PlanoManzanero(iface,'predio')
        PMA.UTI = self.UTI
        PMA.CFG = self.CFG
        PMA.ACA = self
