...
#######################################################################################################
    ...
    def guardarNormales(self):
        ...
        if QSettings().value('posibleGuardar') == 'True':
            ...
            url='http://201.165.150.64:8080/featureswkn/api/manzana/'
...
########################################################################################################################
    ...
    def guardarAreasIns(self):
        ...
        print(payload)
        try:
            response = requests.post('http://201.165.150.64:6543/api/etables/', headers = headers, data = payload)
...
#--------------------------------------------------------------
    ...
    def corregirLineas(self):
        ...
        capacalles = QgsProject.instance().mapLayer(self.obtenerIdCapa('calles'))
        diccCapas = {}
