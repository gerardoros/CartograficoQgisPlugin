    ...
    def abrirCedula(self):
        ...
        if self.tipo == 'PAD':
            ...
            if respuesta.status_code == 200:
                ...
                self.UTI.mostrarAlerta('Error en peticion "abrirCedula()":\n' + respuesta.text, QMessageBox().Critical, "Error de servidor")
                return

            if idPredio == 0:
                self.UTI.mostrarAlerta('Sin Informacion para mostrar', QMessageBox().Information, "Cedula")
                return
