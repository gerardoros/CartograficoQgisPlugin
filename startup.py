...
class Startup():
    ...
    def __init__(self):
        ...
        clickBorrarTodoAlv = QAction(QIcon("/home/jeather/AplicacionQGIS/notify_off.png"), QCoreApplication.translate("Groundwater Modeling", "btnPrueba"), iface.mainWindow())
    ...
    def checarLogin(self):
        ...
        file = Path("/home/jeather/AplicacionQGIS/start.det")
...
#####################################################################################################################################
    ...
    def cargarWebService(self):
        ...
        cabecera = {'Content-type': 'application/json', 'Authorization' : token}
            ...
            #url del service
        url = 'http://192.168.0.21:8080/configuracion/api/adm-capas/getAllCapasConfiguration'
...
##########################################################################################################################
    ...
    def obtenerToken(self):
        ...
        if currentDate > exp:
            ...
            var.setValue('token', json.loads(data.decode('utf-8'))['access_token'])
...
################################################################################################################################
    ...
    def consultarLlenadoDeCapa(self,capaParam):
        ...
        if capaParam == 'predios.num':
            ...
            #urlCapas = 'http://192.168.0.21:8080/busquedasimplewkn/api/thematics/lista/campos/' + stringTabla
