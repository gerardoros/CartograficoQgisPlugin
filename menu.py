    ...
    def fun4(self):
        ...
        if self.capaActiva is not None: #Cuando la capa es seleccionada habilitamos
            ...
            if (len(self.seleccion) == 1):
                ...
                si = "predio cartografiado"
                print('------------menu-----------')
                print(si)
                print('------------menu-----------')
                self.ACA.cargarTablita(str(si))
            else:
                self.UTI.mostrarAlerta("Seleccione un predio", QMessageBox().Critical, "Cedula")
        else:
            self.UTI.mostrarAlerta("Seleccione la capa de predio", QMessageBox().Critical, "Cedula")
